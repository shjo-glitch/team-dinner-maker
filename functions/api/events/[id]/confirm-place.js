...
import { checkManagePin, isScheduleConfirmed, loadEvent, normalizePlaceLink, publicEvent, readJson, saveEvent } from '../../_shared.js';
...
export async function onRequestPost({ request, params, env }) {
  ...
  if (!isScheduleConfirmed(event)) {
    return Response.json({ error: '일정을 먼저 확정해 주세요.' }, { status: 409 });
  }
