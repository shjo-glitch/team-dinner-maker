...
| 일정 확정 | **일정 확정하기** 버튼에서 **만나는 날짜**(1위 후보 날짜만 선택 가능)와 **시간**, 관리 비밀번호를 입력하면 **어디서 볼까?** 탭이 열립니다. 확정 내용은 상단 칩과 장소 화면·링크 미리보기에 표시됩니다. **확정 취소**하면 탭이 닫히고 장소 확정도 함께 풀리지만, 후보지·투표·날짜·시간 값은 보존됩니다. |
